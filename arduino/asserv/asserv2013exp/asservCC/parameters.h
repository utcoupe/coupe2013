...
#define PWM_MINI 100 //pwm minimale corrigeant le bug de "vibration" du robot, mettre à 0 pour les brushless

#define ASSERV_VITESSE 1 //active ou désactive l'asservissement en vitesse.
#define MAX_SPEED 18 //necessaire à l'asserv en vitesse. En tick/ms, la valeur est à calculer : lancer le robot à pwm max et regarder les valeurs de robot_state.speedMotorR/L
 ...
 * pin 0 -> USB 2 TTL
 * pin 1 -> USB 2 TTL
 * pin 3 -> enable moteur 1 (pwm) left
 * pin 12 -> direction moteur 1 left
 * pin 11 -> enable moteur 2 (pwm) right
 * pin 13 -> direction moteur 2 right
