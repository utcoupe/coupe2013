...
#define PIN_LEFT_A 18			// A encodeur 1 (gauche) (Bleu)
#define PIN_LEFT_B 19			// B encodeur 1 (gauche) (Blanc)
#define PIN_RIGHT_A 21			// A encodeur 2 (droite) (Bleu)
#define PIN_RIGHT_B 20			// B encodeur 2 (droite) (Blanc)
// C = jaune
